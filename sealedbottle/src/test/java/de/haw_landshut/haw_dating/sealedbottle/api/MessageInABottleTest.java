...
public class MessageInABottleTest {
    ...
    public void setUp() throws Exception {
        ...
        messageInABottle = new MessageInABottle(new Bottle(new MockProfiles.Search()).fill().cork
                ().seal(), safeWord, hintWords, version);
    }
    ...
    public void testSerialize() throws Exception {
        ...
        message = "hallo";
        Assert.assertNull(MessageInABottle.deSerialize(message));
    }
}